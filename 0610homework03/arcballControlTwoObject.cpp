...
// シェーダファイル
static std::string VERT_SHADER_FILE = std::string(SHADER_DIRECTORY) + "shader/objectSelection.vert";
static std::string FRAG_SHADER_FILE = std::string(SHADER_DIRECTORY) + "shader/objectSelection.frag";
